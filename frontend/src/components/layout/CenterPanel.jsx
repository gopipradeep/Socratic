...
import { BookMarked, Code, Sparkles, ChevronRight, Flame, FileQuestion, ShieldCheck, Lightbulb } from 'lucide-react';

const features = [
    {
        icon: Lightbulb,
        title: "Socratic Tutor",
        description: "Master any topic through guided questioning. The AI acts as a tutor to test and expand your knowledge.",
        path: '/tools/socratic-tutor',
        status: 'active',
        glowColor: 'indigo'
    },
    {
...
const glowStyles = {
    ...
    indigo: "hover:border-indigo-400 dark:hover:border-indigo-500 hover:shadow-[0_0_20px_theme(colors.indigo.500/40%)]",
